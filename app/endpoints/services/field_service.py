...
class FieldService:
    ...
    async def get_fields_in_parallelogram(self, parallelogram):
        stmt = select(
            self.MODEL.id,
            self.MODEL.crop,
            self.MODEL.productivity,
    ...
    async def get_fields_intersecting_geometry(self, figure):
        stmt = select(
            self.MODEL.id,
            self.MODEL.crop,
            self.MODEL.productivity,
    ...
    async def get_agricultural_metrics(self, region):
        stmt = (
            select(
